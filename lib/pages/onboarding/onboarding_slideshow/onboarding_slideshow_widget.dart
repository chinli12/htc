                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    24.0, 0.0, 24.0, 0.0),
                                            child: Image.network(
                                              'https://static.vecteezy.com/system/resources/previews/007/489/384/non_2x/driver-linear-icon-transportation-service-thin-line-illustration-contour-symbol-isolated-outline-drawing-vector.jpg',
                                              height: 250.0,
                                              fit: BoxFit.fill,
                                            ).animateOnPageLoad(animationsMap[
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Search for available driver in the app, and rate them !',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleMedium
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Become a driver and earn your volunteering hours from it , even earn trophies based on some quests !',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleMedium
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    24.0, 0.0, 24.0, 0.0),
                                            child: Image.network(
                                              'https://img.freepik.com/premium-vector/smile-line-art-element-vector-design_607286-3491.jpg',
                                              height: 250.0,
                                              fit: BoxFit.contain,
                                            ).animateOnPageLoad(animationsMap[
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Enjoy our app that helps our planet to stay green by reducing the amount of student driving to HCT and instead having a classmate/student drive you here !',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
