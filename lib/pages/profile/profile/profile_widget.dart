                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'PROFILE_PAGE_Row_f4v9dmlr_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (columnCompanyInformationRecord
                                        ...
                                        await launchUrl(Uri(
                                          scheme: 'mailto',
                                          path: columnCompanyInformationRecord!
                                              .email,
                                        ));
                                      } else {
                                        logFirebaseEvent(
