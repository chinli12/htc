...
import 'managedriver_model.dart';
export 'managedriver_model.dart';

class ManagedriverWidget extends StatefulWidget {
  /// create a page that list drivers with good UI/UX .add option to search for
  /// area/location
  /// - search for time use good UI/UX
  const ManagedriverWidget({super.key});

  @override
  State<ManagedriverWidget> createState() => _ManagedriverWidgetState();
}

class _ManagedriverWidgetState extends State<ManagedriverWidget> {
  late ManagedriverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManagedriverModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'managedriver'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('MANAGEDRIVER_arrow_back_rounded_ICN_ON_T');
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'MANAGEDRIVER_PAGE_VIEW_BTN_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Button_navigate_to');
