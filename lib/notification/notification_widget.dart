                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'NOTIFICATION_PAGE_Text_1bnzw0k6_ON_TAP');
                                  ...
                                  _model.loop = 0;
                                  safeSetState(() {});
                                  while (_model.loop! < _model.notify!.length) {
                                    logFirebaseEvent('Text_backend_call');

                                    await _model.notify![_model.loop!].reference
                                    ...
                                    children: [
                                      ...
                                      if (listViewNotificationRecord.type ==
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'NOTIFICATION_Container_a4uotdjv_ON_TAP');
                                            logFirebaseEvent(
