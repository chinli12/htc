        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'OfferRidePage',
              path: 'offerRidePage',
              builder: (context, params) => OfferRidePageWidget(),
            ),
            FFRoute(
              name: 'RequestRidePage',
              path: 'requestRidePage',
              builder: (context, params) => RequestRidePageWidget(),
            ),
            FFRoute(
              name: 'ProfilePage',
              path: 'profilePage',
            ...
            FFRoute(
              ...
              builder: (context, params) => RideDetailsPageWidget(),
            ),
            FFRoute(
              name: 'driver0nboarding',
              path: 'driver0nboarding',
              builder: (context, params) => Driver0nboardingWidget(),
            ),
            FFRoute(
              name: 'thankyou',
              path: 'thankyou',
            ...
            FFRoute(
              ...
              path: 'driverprofile',
              asyncParams: {
                'driver': getDoc(['Driver'], DriverRecord.fromSnapshot),
              },
            ...
            FFRoute(
              name: 'Ridepage',
              path: 'ridepage',
              builder: (context, params) => RidepageWidget(),
            ),
            FFRoute(
              name: 'bookpage',
              path: 'bookpage',
            ...
            FFRoute(
              name: 'driverdashoboard',
              path: 'driverdashoboard',
              builder: (context, params) => DriverdashoboardWidget(),
            ),
            FFRoute(
              name: 'bookedview',
              path: 'bookedview',
              asyncParams: {
                'doc': getDoc(['booking'], BookingRecord.fromSnapshot),
              },
              builder: (context, params) => BookedviewWidget(
            ...
            FFRoute(
              name: 'managedriver',
              path: 'Managedriver',
              builder: (context, params) => ManagedriverWidget(),
            ),
            FFRoute(
              name: 'Notification',
              path: 'notification',
